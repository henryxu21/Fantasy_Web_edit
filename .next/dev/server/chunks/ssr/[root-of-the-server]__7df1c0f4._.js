...
function SignupPage() {
    ...
    const handleSubmit = (e)=>{
        ...
        setLoading(true);
        setErr(null);
        const res = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["signup"])(name, email, pw);
        if (!res.ok) {
            setErr(res.error);
            setLoading(false);
            return;
...
//# sourceMappingURL=%5Broot-of-the-server%5D__7df1c0f4._.js.map